...
class DefaultExtractorService(MainPartsExtractorService):
    def extract(self, docs: Documents) -> Documents:
        return docs
...
default_extractor_service = DefaultExtractorService()
...
def _get_embeddings(
    ...
    embeddings = openai.embeddings.create(model="text-embedding-3-small", input=pages).data
