...
def summarize_documents(summaries: PdfSummaries, llm: Union[
    Runnable[LanguageModelInput, str], Optional[Runnable[LanguageModelInput, BaseMessage]
]] = None, embeddings: Optional[Embeddings] = None, embeddings_function: Optional[Callable[[list[str]], list[Embedding]]] = None, load_embeddings: bool = True) -> str:
    ...
    for doc in tqdm(docs, desc="Processing documents"):
        ...
        final_summary += new_summary.replace('The passage does not provide useful information for constructing related work.', '') + "\n"
